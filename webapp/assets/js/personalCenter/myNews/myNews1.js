...
var NewsPage = {
    ...
    tab:function(){
        ...
        $(".class-tit").click(function () {
            /*NewsPage.myNewsScroll.destroy();
            NewsPage.classScroll();*/
            NewsPage.classNewsView();
        })
        $(".myNew-tit").click(function () {
            /*NewsPage.classScroll.destroy();
            NewsPage.myNewsScroll();*/
            NewsPage.myNewsView();
        })
    },
    // 班级通知页面初始化ajax数据请求
